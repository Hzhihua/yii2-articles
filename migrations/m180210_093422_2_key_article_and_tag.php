...
/**
 * Class m180210_093422_2_key_article_and_tag
 * @property \yii\db\Transaction $_transaction
 * @Author Hzhihua <cnzhihua@gmail.com>
 */
class m180210_093422_2_key_article_and_tag extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->runSuccess['tags_id'] = $this->createIndex('tags_id', '{{%article_and_tag}}', 'tag_id', 0);
