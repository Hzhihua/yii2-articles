...
/* @var $searchModel \hzhihua\articles\models\search\ArticleCategorySearch */
/* @var $dataProvider \yii\data\ActiveDataProvider */

$this->title = Yii::t('articles', 'Article Category');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="article-category-index box box-primary">
    <div class="box-header with-border">
        <?= HtmlHelper::a(Yii::t('articles', 'Create') . Yii::t('articles', 'Article Category'), ['create'], ['class' => 'btn btn-success btn-flat']) ?>
    </div>
